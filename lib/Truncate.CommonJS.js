...
var Truncate = function (_Component) {
    ...
    _createClass(Truncate, [{
        ...
        value: function getLines() {
            ...
            var wordSeparator = breakAll ? '' : ' ';
            var textLines = text.split('\n').map(function (line) {
                return line ? line.split(wordSeparator) : [""];
            });
            ...
            for (var line = 1; line <= numLines; line++) {
                ...
                var resultLine = textWords.join(wordSeparator);
                ...
                if (line === numLines) {
                    ...
                    var textRest = textWords.join(wordSeparator);
                    ...
                    while (_lower <= _upper) {
                        ...
                        var _testLine = textWords.slice(0, _middle + 1).join(wordSeparator);
                    ...
                    resultLine = textWords.slice(0, _lower).join(wordSeparator);
...
Truncate.propTypes = {
    ...
    breakAll: _propTypes2.default.bool
};
